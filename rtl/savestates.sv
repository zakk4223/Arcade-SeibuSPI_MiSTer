//============================================================================
//  Vendored from Arcade-IGSPGM_MiSTer, rtl/savestates.sv
...
// -- SeibuSPI: COUNT is the number of SSIDX sections to walk, and the slot
//    stride and length come from system_consts rather than being PGM's 4 MB
//    written twice as a literal.
memory_stream #(.COUNT(SSIDX_COUNT)) memory_stream (
    .clk(clk),
    .reset(reset),
    ...
    .start_addr(SS_DDR_BASE + (32'(index) * SS_SLOT_SIZE)),
    .length(SS_SLOT_SIZE),
